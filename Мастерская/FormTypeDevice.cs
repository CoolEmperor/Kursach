...
{
    public partial class FormTypeDevice : Form
    {
        string connectionString = "Data Source=DMITRYBUGAI-LAP\\SQLEXPRESS;Initial Catalog=Мастерская;Integrated Security=True";

        public FormTypeDevice()
        {
            InitializeComponent();
        }

        private void FormTypeDevice_Load(object sender, EventArgs e)
        {
        ...
        {
            int selectedTypeId = (int)dataGridView1.CurrentRow.Cells[0].Value;
